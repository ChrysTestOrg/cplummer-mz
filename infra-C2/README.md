...
1. [ACCESS_KEYS_ROTATED](https://docs.aws.amazon.com/config/latest/developerguide/access-keys-rotated.html) (global)
...
1. [IAM_PASSWORD_POLICY](https://docs.aws.amazon.com/config/latest/developerguide/iam-password-policy.html) (global)
...
1. [IAM_ROOT_ACCESS_KEY_CHECK](https://docs.aws.amazon.com/config/latest/developerguide/iam-root-access-key-check.html) (global)
...
1. [ROOT_ACCOUNT_MFA_ENABLED](https://docs.aws.amazon.com/config/latest/developerguide/root-account-mfa-enabled.html) (global)
...
1. [CLOUDTRAIL_SECURITY_TRAIL_ENABLED](https://docs.aws.amazon.com/config/latest/developerguide/cloudtrail-security-trail-enabled.html) (regional)
...
1. [EBS_SNAPSHOT_PUBLIC_RESTORABLE_CHECK](https://docs.aws.amazon.com/config/latest/developerguide/ebs-snapshot-public-restorable-check.html) (regional)
...
1. [EFS_MOUNT_TARGET_PUBLIC_ACCESSIBLE](https://docs.aws.amazon.com/config/latest/developerguide/efs-mount-target-public-accessible.html) (regional)
...
1. [LAMBDA_FUNCTION_PUBLIC_ACCESS_PROHIBITED](https://docs.aws.amazon.com/config/latest/developerguide/lambda-function-public-access-prohibited.html) (regional)
...
1. [RDS_INSTANCE_PUBLIC_ACCESS_CHECK](https://docs.aws.amazon.com/config/latest/developerguide/rds-instance-public-access-check.html) (regional)
...
1. [RDS_INSTANCE_SUBNET_IGW_CHECK](https://docs.aws.amazon.com/config/latest/developerguide/rds-instance-public-access-check.html) (regional)
*Policy*: RDS instances should not be deployed in a public subnet (i.e. a subnet with a route to an internet gateway).

*Rationale*: Publicly reachable databases are exposed to the internet, increasing the attack surface for brute‑force, exploitation, and data theft.

1. [RDS_SNAPSHOTS_PUBLIC_PROHIBITED](https://docs.aws.amazon.com/config/latest/developerguide/rds-snapshots-public-prohibited.html) (regional)
...
1. [EC2_EBS_ENCRYPTION_BY_DEFAULT](https://docs.aws.amazon.com/config/latest/developerguide/ec2-ebs-encryption-by-default.html) (regional)
...
1. [EFS_FILESYSTEM_CT_ENCRYPTED](https://docs.aws.amazon.com/config/latest/developerguide/efs-filesystem-ct-encrypted.html) (regional)
...
1. [RDS_CLUSTER_ENCRYPTED_AT_REST](https://docs.aws.amazon.com/config/latest/developerguide/rds-cluster-encrypted-at-rest.html) (regional)
...
1. [RDS_SNAPSHOT_ENCRYPTED](https://docs.aws.amazon.com/config/latest/developerguide/rds-snapshot-encrypted.html) (regional)
...
1. [RDS_STORAGE_ENCRYPTED](https://docs.aws.amazon.com/config/latest/developerguide/rds-storage-encrypted.html) (regional)
...
1. [REDSHIFT_CLUSTER_PUBLIC_ACCESS_CHECK](https://docs.aws.amazon.com/config/latest/developerguide/redshift-cluster-public-access-check.html) (regional)
...
1. [S3_ACCESS_POINT_PUBLIC_ACCESS_BLOCKS] (https://docs.aws.amazon.com/config/latest/developerguide/s3-access-point-public-access-blocks.html) (regional)
...
1. [S3_BUCKET_LEVEL_PUBLIC_ACCESS_PROHIBITED](https://docs.aws.amazon.com/config/latest/developerguide/s3-bucket-level-public-access-prohibited.html) (regional)
...
1. [IAM_USER_MFA_ENABLED](https://docs.aws.amazon.com/config/latest/developerguide/iam-user-mfa-enabled.html) (global)
*Policy*: All IAM users with password-based access to the AWS management console should have MFA enabled.

*Rationale*:

1. [RDS_MARIADB_INSTANCE_ENCRYPTED_IN_TRANSIT](https://docs.aws.amazon.com/config/latest/developerguide/rds-mariadb-instance-encrypted-in-transit.html) (regional)
...
1. [RDS_MYSQL_INSTANCE_ENCRYPTED_IN_TRANSIT](https://docs.aws.amazon.com/config/latest/developerguide/rds-mysql-instance-encrypted-in-transit.html) (regional)
*Policy*: All MySQL RDS instances should require encrypted access.

*Rationale*: Encryption in transit for SQL clients prevents exposure of data while it traverses the network.

1. [RDS_POSTGRES_INSTANCE_ENCRYPTED_IN_TRANSIT](https://docs.aws.amazon.com/config/latest/developerguide/rds-postgres-instance-encrypted-in-transit.html) (regional)
*Policy*: All PostgreSQL RDS instances should require encrypted access.

*Rationale*: Encryption in transit for SQL clients prevents exposure of data while it traverses the network.

1. [RDS_SQLSERVER_INSTANCE_ENCRYPTED_IN_TRANSIT](https://docs.aws.amazon.com/config/latest/developerguide/rds-sqlserver-encrypted-in-transit.html) (regional)
*Policy*: All Microsoft SQLServer RDS instances should require encrypted access.

*Rationale*: Encryption in transit for SQL clients prevents exposure of data while it traverses the network.

1. [REDSHIFT_REQUIRE_TLS_SSL](https://docs.aws.amazon.com/config/latest/developerguide/redshift-require-tls-ssl.html) (regional)
*Policy*: Redshift clusters should have `require_SSL` parameter set to true.

*Rationale*: Encryption in transit for SQL clients prevents exposure of data while it traverses the network.

1. [S3_BUCKET_SSL_REQUESTS_ONLY] (https://docs.aws.amazon.com/config/latest/developerguide/s3-bucket-ssl-requests-only.html) (regional)
...
- Trust Policy (custom): [`iam-trust-mfa-users`](iam-trust-mfa-users.json)
